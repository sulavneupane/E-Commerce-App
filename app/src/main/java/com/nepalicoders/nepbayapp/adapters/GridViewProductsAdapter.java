...
import com.nepalicoders.nepbayapp.activities.SearchResult;
...
public class GridViewProductsAdapter extends BaseAdapter{
    ...
    public GridViewProductsAdapter(Context c, List<Product> products){
        mContext = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(v == null){
            v = inflater.inflate(R.layout.fragment_templates_grid_view_single_product,parent, false);
